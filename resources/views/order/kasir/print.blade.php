...
<body>
    ...
    <div id="receipt">
        ...
        <center id="top">
            <div class="info">
                <h2>Apotek Indahnya Dirimu!</h2>
            </div>
        </center>
        <div id="mid">
            <div class="info">
                <p>
                    Alamat: Sepanjang Jalan-Jalan <br>
                    Email: indahnyadirimu@gmail.com <br>
                    Phone: 121-232-323
                </p>
            </div>
        </div>
        ...
        <div id="bot">
            ...
            <div id="legalcopy">
                <p class="legal">
                    <strong>Terima kasih atas pembelian Anda di Toko Indahnya Dirimu!</strong> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius, illum?
                </p>
            </div>
        </div>
    </div>
